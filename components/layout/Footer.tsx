          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-black/40 border border-[#A374FF]/20 rounded-lg px-4 py-2 text-gray-300 placeholder-gray-500 focus:outline-none focus:border-[#A374FF]/50"
              />
              <button className="bg-[#A374FF] hover:bg-[#A374FF]/80 text-white px-4 py-2 rounded-lg transition-colors">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-[#A374FF]/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <a
                href="#"
                className="text-gray-400 hover:text-[#A374FF] transition-colors"
              >
                Privacy Policy
              </a>
              <a
