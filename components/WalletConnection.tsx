...
const WalletConnection = () => {
  ...
  const { select, signMessage, wallets, publicKey, disconnect, connected } = useWallet()
  ...
  const fetchTransactions = async () => {
    ...
    try {
      ...
      const signatures = await connection.getSignaturesForAddress(publicKey, { limit: 5 }, "confirmed")
            ...
            <Drawer open={drawerOpen} direction={"right"} onOpenChange={setDrawerOpen}>
              <DrawerTrigger asChild>
                ...
                >
                  ...
                  {balance !== null ? <span>{toFixed(balance, 2)} SOL</span> : <span>0 SOL</span>}
                </Button>
              </DrawerTrigger>
              <DrawerContent className="bg-[#0D0D15]/95 border-[#00E5FF]/30">
                <div className="flex flex-col h-full">
                  <div className="flex-1">
                    <DrawerHeader>
                      <DrawerTitle className="text-gray-200">Wallet Details</DrawerTitle>
                    ...
                    <div className="p-4 space-y-6">
                      <div>
                        <h4 className="text-sm font-medium mb-2 text-gray-400">Balance</h4>
                      ...
                      <div>
                        <h4 className="text-sm font-medium mb-2 text-gray-400">Wallet Address</h4>
                        <div className="p-4 rounded-lg bg-[#141425] border border-[#00E5FF]/30 flex items-center justify-between break-all">
                          <div className="text-sm text-gray-300">{publicKey.toBase58()}</div>
                          <div className="flex gap-2 ml-2 shrink-0">
                            <Button
                              ...
                              onClick={copyAddress}
                            >
                              <Copy className={cn("h-4 w-4", copied ? "text-[#4ADE80]" : "text-gray-400")} />
                            </Button>
                            <Button
                              variant="ghost"
                              size="icon"
                      ...
                      <div>
                        <h4 className="text-sm font-medium mb-2 text-gray-400">Recent Activity</h4>
                        {loadingTransactions ? (
                                ...
                                <div className="flex justify-between items-center">
                                  <div className="flex items-center gap-2">
                                    {(() => {
                                      ...
                                      return (
                                        <div className={`text-sm ${amount >= 0 ? "text-[#4ADE80]" : "text-red-500"}`}>
                                          {amount >= 0 ? "+" : ""}
